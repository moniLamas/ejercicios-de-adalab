        ...
        <nav class="menu">
          <ul class="menu__items">
            <li class="menu__item menu__item--twitter">
              <a class="menu__link" href="/home" title="Ir">
            ...
            <li class="menu__item menu__item--search">
              <a class="menu__link" href="/search" title="Buscar">
                <span class="text">Buscar</span>
              </a>
            </li>

            <li class="menu__item menu__item--profile">
              <a class="menu__link" href="/profile" title="Perfil">
                <span class="text">Perfil</span>
              </a>
            </li>

            <li class="menu__item menu__item--tweet">
              <a class="menu__link" href="/compose/tweet" title="Twittear">
